...
* First, determine which base branch your bug fix should use. If your bug is present in both hotfix and hotfix-7.8.x then you will need to make a seperate pull request for each branch.
