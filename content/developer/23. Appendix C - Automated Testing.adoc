...
---
weight: 23
title: "23. Appendix C - Automated Testing"
---
...
Automated testing provides a means to ensure that the quality of the SuiteCRM is kept to a high standard. SuiteCRM has automated test framework, which is powered by the http://codeception.com[codeception] testing framework.
...
Codeception and the other commands live inside the vendor/bin/ directory of your SuiteCRM instance. To test that your configuration is working you need to first install your copy of suitecrm. After install suitecrm you can run the unit tests:
...
| INSTANCE_INSTANCE_ADMIN_USER |admin user for logging in
