...
link:../entry-points#entry-point-chapter[Entry Points].
...
|Language |N/A^link:../extension-framework#fn-langNote[1]^ |  |Used to add, update
or delete language strings for both modules and app strings. See the
chapter on link:../language-strings#language-chapter[Language Strings].
...
hooks. See the chapter on link:../logic-hooks#logic-hooks-chapter[Logic
Hooks].
...
a module. See the section on link:../vardefs#vardefs-chapter[Vardefs].
...
see the chapter on link:../vardefs#vardefs-chapter[Vardefs]).
...
compiled to a single file.link:../extension-framework#fnref-langNote[↩]
