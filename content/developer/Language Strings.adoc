...
See the link:../developer/Extension%20Framework.adoc/[extensions] section for more information on the Extensions
folder.
...
See the link:../developer/Extension%20Framework.adoc/[extensions] section for more information on the Extensions folder.
