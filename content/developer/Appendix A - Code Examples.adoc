...
link:../metadata#metadata-chapter[Metadata] chapter for more
information).
...
link:../module-installer#module-installer-chapter[Module Installer] chapter.
