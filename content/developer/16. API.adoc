...
*_Example 16.1: SOAP API WSDL Location_*
...
*_Example 16.2: Accessing the SOAP API_*
...
*_Example 16.3: REST API Endpoint Location_*
...
*_Example 16.4: Accessing the REST API_*
...
*_Example 16.5: Custom v4_1 Web Service Implementation_*
...
*_Example 16.6: Custom v4_1 web service registry_*
...
*_Example 16.7: Custom v4_1 REST Entry point_*
...
*_Example 16.8: Custom v4_1 SOAP Entry point_*
...
*_Example 16.9: Custom v4_1 URLS_*
