...
When developing some complex JavaScript functionality is very useful to have module vardefs definitions or custom data in the DOM so you can read it from JavaScript.
