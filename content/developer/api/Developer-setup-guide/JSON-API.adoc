...
[source,php]
GET {{suitecrm.url}}/V8/module/{moduleName}/relationships/{relation}
...
[source,php]
POST {{suitecrm.url}}/V8/module/{moduleName}/relationships/{relation}
...
[source,php]
POST {{suitecrm.url}}/V8/module/{moduleName}/{id}/relationships
