...
[source,php]
GET {{your-SuiteCRM-url}}/V8/module/{moduleName}/{id}/relationships/{relation}

Example:

[source,php]
V8/module/Accounts/11a71596-83e7-624d-c792-5ab9006dd493/relationships/aos_contracts
