...
*_Example 6.1: Module metadata location_*
[source,php]
...
*_Example 6.2: DetailView metadata definition_*
...
*_Example 6.3: DetailView metadata row definition_*
...
*_Example 6.4: DetailView metadata displayParams_*
...
*_Example 6.5: ListView metadata definition_*
...
*_Example 6.6: PopupView metadata definition_*
...
*_Example 6.7: Search View metadata definition_*
...
*_Example 6.8: Subpanel metadata definition_*
...
*_Example 6.8: Module Subpanels definition_*
