...
*_Example 5.1: View for a custom module_*
...
*_Example 5.2: Detail view for a custom module, ABC_Vehicles_*
...
*_Example 5.3: Custom view for an existing module_*
...
*_Example 5.4: Overriding a view for an existing module_*
...
*_Example 5.5: Overriding the Accounts List View_*
