...
the purchase of the https://www.sugaroutfitters.com/addons/securitysuite[SecuritySuite] 
plugin{{%/notice%}}
...
* link:/user/security-suite-groups/#_a_typical_hierarchy_setup[Example of a Typical Setup]
