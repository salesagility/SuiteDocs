...
Important - This release resolves an important issue in 7.11.16 and 7.11.17 that can cause issue in many areas of the crm, including in reports, roles and currency. We recommend all user of 7.11.16 and 7.11.17 to upgrade to this release asap.
