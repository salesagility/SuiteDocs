...
Release Notes
~~~~~~~~~~~~~
* *Security* - Improved HTML cleaning 
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.8.7[7.8.7]
--------------------------------------------------------------------
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.8.6[7.8.6]
--------------------------------------------------------------------
...
*Users of ALL previous 7.9.x releases are advised to Upgrade to 7.9.4 as soon as possible.*

This Release contains all the Security Patches from the previous 7.9.3 Release.
...
*Updates a Security vulnerability with Serialized Input, to prevent
possible object,file, beans and SQL injection attacks. Users of ALL previous releases are advised to Upgrade to 7.6.7 as soon
as possible*
...
[discrete]
===== Security
Includes *SugarCRM 6.5.24* - more information http://support.sugarcrm.com/Documentation/Sugar_Versions/6.5/CE/Sugar_Release_Notes_6.5.24/[here]
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.6[7.6.0]
-----------------------------------------------------------------
...
This update addresses some Security issues, further details can be found http://support.sugarcrm.com/Documentation/Sugar_Versions/6.5/CE/Sugar_Release_Notes_6.5.23/ [here]
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.5[7.5.0]
-----------------------------------------------------------------
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.4[7.4.0]
-----------------------------------------------------------------
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.3[7.3.0]
-----------------------------------------------------------------
...
https://github.com/salesagility/SuiteCRM/releases/tag/v7.2[7.2.0]
-----------------------------------------------------------------

Released this Mar 2, 2015
...
This update addresses some important Security issues, further details can be found http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/05_Sugar_Community_Edition/Sugar_Community_Edition_6.5/Sugar_Community_Edition_Release_Notes_6.5.20/[here]
...
Release Notes
~~~~~~~~~~~~~
SuiteCRM 7.1.4 features many bug fixes and addresses important security issues.

*Upgraded Sugar to 6.5.18* +
This update addresses some important Security issues, further details can be found http://support.sugarcrm.com/02_Documentation/01_Sugar_Editions/05_Sugar_Community_Edition/Sugar_Community_Edition_6.5/Sugar_Community_Edition_Release_Notes_6.5.18[here]

*Upgraded QuickCRM* +
This update addresses an important security issue.
...
Release Notes
~~~~~~~~~~~~~
SuiteCRM 7.1.3 features many bug fixes which address bugs in previous SuiteCRM releases.
