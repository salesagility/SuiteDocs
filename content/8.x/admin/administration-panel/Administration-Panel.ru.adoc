...
При наведении мыши на элемент панели она будет подсвечена и в подсказке отобразится краткое описание выбранной настройки.
...
* {adm-email}[Emails]
** {adm-email}#_настройка_e_mail[Настройка основных параметров E-mail]
...
** {adm-google-maps}[Тестирование геокодирования]
