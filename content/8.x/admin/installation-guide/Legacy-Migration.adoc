...
*1* - Download the SuiteCRM 8.x target version migration package (e.g. 8.x 7.12.x Migration) from link:https://suitecrm.com/upgrade-suitecrm/[SuiteCRM Release page.]
