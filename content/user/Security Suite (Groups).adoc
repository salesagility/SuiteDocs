...
Security Suite is very configurable and allows for support near every
...
automatically inherit based on your Security Suite Settings. You can also
...
all records in the group would have a role assigned directly to the manager's
...
Although Security Suite can handle any organizational structure, the most
common scenario is one where the owner can see
everything, managers can see both their own records as well as those of their
