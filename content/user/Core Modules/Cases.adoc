...
link:./../../advanced-modules/cases-with-portal/[Cases with Portal] section of this
User Guide.
...
* To search for a Case, see the link:./../../introduction/user-interface/search[Search] section of this
user guide.
