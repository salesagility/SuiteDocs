...
the link:../../../admin/administration-panel/email[Emails] section of the Administrator Guide.
{{% /notice %}}
...
See link:../../../admin/administration-panel/email/#_group_email_account[Group Email Accounts] for more information.
