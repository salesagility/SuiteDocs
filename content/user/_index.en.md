...
Jason Eggers developed Security Suite. Security Suite allows control of
what users can access. It can restrict the access of sensitive data in
SuiteCRM to specific teams (groups). SecuritySuite comes loaded with
options which allow you to configure it to meet your exact needs. Choose
from a number of automatic assignment options to ensure that your users
can always access the data that you need. Jason and his team have
contributed the Security Suite section of the documentation. They know
the application inside out and provide great support. A feature packed
premium version of Security Suite is available at [the SuiteCRM
Store](https://store.suitecrm.com/). The SuiteCRM Store
provides curated add-ons with unrivalled support. Visit the website for
a full list of third party modules available for SuiteCRM.

## Dale Murray

Dale Murray is the Head of Consulting at SalesAgility. Dale wrote the
original guides for Advanced OpenSales, Advanced OpenWorkflow, Advanced
OpenPortal, Advanced OpenEvents and Reschedule. All of these modules
were originally extensions to SugarCRM Community Edition which were
written and maintained by SalesAgility. These are now within the core of
SuiteCRM. Each guide has been fully updated to incorporate the new
functionality that has been added to these modules within SuiteCRM.

## What is SuiteCRM?

SuiteCRM is a software fork of the popular [Customer Relationship
Management](https://en.wikipedia.orghttps://suitecrm.com/wiki/Customer_relationship_management) (CRM) system
[SugarCRM](https://en.wikipedia.orghttps://suitecrm.com/wiki/SugarCRM),
developed and maintained by SalesAgility. It is a free and open source
alternative application. It was released on October 21, 2013 as version
7.0. The latest production version at the time of publishing this User
Guide is SuiteCRM 7.6.3.
...
[SuiteCRM:OnDemand](https://suitecrmondemand.com/), a
Software As A Service facility for users who seek a rapid deployment and
...
![Image1.png](https://suitecrm.com/wiki/images/c/c3/Image1.png)

![Image2.png](https://suitecrm.com/wiki/images/e/ee/Image2.png)
...
![Image3.png](https://suitecrm.com/wiki/images/c/cc/Image3.png)
...
![Image4.png](https://suitecrm.com/wiki/images/5/50/Image4.png)
...
![Image5.png](https://suitecrm.com/wiki/images/b/bb/Image5.png)
...
a red star(\*) are required fields, and as such need to be filled in
with valid data before you can progress.

![Image6.png](https://suitecrm.com/wiki/images/1/15/Image6.png)
...
![Image7.png](https://suitecrm.com/wiki/images/4/43/Image7.png)
...
![Image8.png](https://suitecrm.com/wiki/images/c/cc/Image8.png)
...
![Image9.png](https://suitecrm.com/wiki/images/b/b8/Image9.png)
...
![Image10.png](https://suitecrm.com/wiki/images/2/2b/Image10.png)
...
![Image11.png](https://suitecrm.com/wiki/images/1/18/Image11.png)
...
![Image12.png](https://suitecrm.com/wiki/images/1/19/Image12.png)
...
![Image13.png](https://suitecrm.com/wiki/images/7/76/Image13.png)
...
![Image14.png](https://suitecrm.com/wiki/images/thumb/1/1b/Image14.png/850px-Image14.png)
...
![Image15.png](https://suitecrm.com/wiki/images/2/24/Image15.png)

If you have forgotten your password and cannot login, you can use the
forgotten password functionality detailed in the [Getting
Started](#Getting_Started) section of this User Guide.
...
![Image16.png](https://suitecrm.com/wiki/images/9/9d/Image16.png)
...
![Image17.png](https://suitecrm.com/wiki/images/thumb/5/5f/Image17.png/850px-Image17.png)
...
![Image18.png](https://suitecrm.com/wiki/images/9/9f/Image18.png)
...
![Image19.png](https://suitecrm.com/wiki/images/4/4d/Image19.png)
...
-   Module Menu – This lists or groups the modules, dependent on the
    user preference. This provides the ability for users to navigate to
    modules within the CRM.
-   Desktop Notification Count – This shows the number of desktop
    ...
    user. For full details on Desktop Notifications, see the [Desktop
    Notifications](#Desktop_Notifications) section within this user
    guide.
-   Quick Create – Quick create allows the quick creation of key module
    records globally within the CRM.
-   Global/Full Text Search – Allows users to search the CRM globally
    for records/data.
-   User menu – This displays the user name for the user currently
    logged in. There is a drop down menu which gives users access to
    Employees, their profile, the about page and a link to logout.

![Image20.png](https://suitecrm.com/wiki/images/thumb/a/a1/Image20.png/880px-Image20.png)
...
[Views](#Views) section of this user guide.
...
![Image21.png](https://suitecrm.com/wiki/images/b/b9/Image21.png)
...
![Image22.png](https://suitecrm.com/wiki/images/0/06/Image22.png)
...
user preferences, see the [Managing User
Accounts](#Managing_User_Accounts) section of this user guide.

![Image23.png](https://suitecrm.com/wiki/images/d/d0/Image23.png)

The grouped tab navigation menu gives the user the ability to group
modules within a tab such as the Sales Tab.

![Image24.png](https://suitecrm.com/wiki/images/7/76/Image24.png)

### Quick Create

You can click the plus '+' icon in the top navigation menu to access the
...
![Image25.png](https://suitecrm.com/wiki/images/c/c3/Image25.png)
...
![Image26.png](https://suitecrm.com/wiki/images/6/6d/Image26.png)
...
![Image27.png](https://suitecrm.com/wiki/images/5/5c/Image27.png)
...
![Image28.png](https://suitecrm.com/wiki/images/4/40/Image28.png)
...
![Image29.png](https://suitecrm.com/wiki/images/5/5b/Image29.png)

You can modify dashlets by clicking the pencil icon on the desired
dashlet.

![Image30.png](https://suitecrm.com/wiki/images/f/fc/Image30.png)
...
![Image31.png](https://suitecrm.com/wiki/images/0/0c/Image31.png)
...
*Note: Some dashlets require the home page to be reloaded. For dashlets
...
![Image32.png](https://suitecrm.com/wiki/images/b/b5/Image32.png)
...
![Image33.png](https://suitecrm.com/wiki/images/c/cb/Image33.png)
...
![Image34.png](https://suitecrm.com/wiki/images/d/db/Image34.png)
...
![My Activity
Stream.png](https://suitecrm.com/wiki/images/f/f9/My_Activity_Stream.png)
...
![Reply Delete.png](https://suitecrm.com/wiki/images/7/70/Reply_Delete.png)

Your posts can also be deleted from the Activity Stream by clicking on
the Delete button.

![Activity Stream
Comment.png](https://suitecrm.com/wiki/images/e/ea/Activity_Stream_Comment.png)
...
![Activity Stream
Update.png](https://suitecrm.com/wiki/images/d/d6/Activity_Stream_Update.png)

Your colleagues will see this message and will be able to respond by
clicking on the Reply button on the right side of the post.

![Activity Stream Update
Reply.png](https://suitecrm.com/wiki/images/d/db/Activity_Stream_Update_Reply.png)

Their response will appear under your post, again with a timestamp.

![Activity Stream Update
Replied.png](https://suitecrm.com/wiki/images/f/ff/Activity_Stream_Update_Replied.png)
...
![Image35.png](https://suitecrm.com/wiki/images/1/1c/Image35.png)
...
![Image36.png](https://suitecrm.com/wiki/images/0/0b/Image36.png)
...
The full text global search is powered by [Zend
Lucene](http://framework.zend.com/manual/1.12/en/zend.search.lucene.overview.html) search framework. The search works very similar to the standard
...
*Note: System Administrators can enable/disable the full text search by
clicking on the AOD Settings link within the admin panel.*

![Image37.png](https://suitecrm.com/wiki/images/0/02/Image37.png)

This will display the AOD option to enable/disable the full text search.

![Image38.png](https://suitecrm.com/wiki/images/a/a1/Image38.png)
...
![Image39.png](https://suitecrm.com/wiki/images/b/bb/Image39.png)
...
![Image40.png](https://suitecrm.com/wiki/images/a/a7/Image40.png)
...
![Image41.png](https://suitecrm.com/wiki/images/4/4d/Image41.png)
...
*Note: System Administrators can modify which fields are searchable in
...
![Image42.png](https://suitecrm.com/wiki/images/8/84/Image42.png)

You can add further fields to the Advanced Search section by expanding
the 'Layout Options' panel.

![Image43.png](https://suitecrm.com/wiki/images/0/02/Image43.png)
...
![Image44.png](https://suitecrm.com/wiki/images/2/2e/Image44.png)

To load a saved search, you can select the saved search from the 'Saved
Searches' drop down and then click 'Search'. This will return results
that match the criteria specified in the saved search.

![Image45.png](https://suitecrm.com/wiki/images/3/36/Image45.png)
...
![Image46.png](https://suitecrm.com/wiki/images/b/b3/Image46.png)
...
-   Search Records – provides you with the ability to perform basic and
    advanced searches, as covered previously in the [Search](#Search)
    section of this chapter.
-   Sort Records – clicking on the column name will sort the record list
    by that column either ascending or descending, if sorting is
    enabled.
-   View Records – clicking on any hyperlinked data will take you to the
    Detail View of the record.
-   Edit Records – clicking the pencil icon will navigate you to the
    Edit View for that record.
-   Delete Records – you can select records and then select the delete
    option to delete records from the module.
-   Mass Update Records – you can select records and then select the
    mass update option to update data on all selected records.
-   Merge Records – you can select records and select the merge option.
    This will begin the merge records processes. You can select a
    primary record and then can merge the data from the duplicate
    records into the primary record. Once saved, the duplicate records
    will be deleted and all data/history merged to the primary record.

### Detail View

This is the view that you are presented with when you view a record.

![Image47.png](https://suitecrm.com/wiki/images/3/35/Image47.png)
...
-   Delete – allows you to delete the record you are viewing. If a
    record is deleted, you will be redirected to the List View.
...
*Note: System Administrators can select to display data in either tabs
...
![Image48.png](https://suitecrm.com/wiki/images/b/b7/Image48.png)
...
![Image49.png](https://suitecrm.com/wiki/images/d/dc/Image49.png)

![Image50.png](https://suitecrm.com/wiki/images/0/0c/Image50.png)

![Image51.png](https://suitecrm.com/wiki/images/a/a8/Image51.png)
...
previously in the [User Interface](#User_Interface) section. This allows
you to fill in the appropriate data for that record. Fields with the red
star(\*) are required fields. Validation is performed so that a record
cannot be saved within the CRM unless data is valid for required fields.

![Image52.png](https://suitecrm.com/wiki/images/2/25/Image52.png)
...
![Image53.png](https://suitecrm.com/wiki/images/e/ec/Image53.png)

![Image54.png](https://suitecrm.com/wiki/images/1/1f/Image54.png)

![Image55.png](https://suitecrm.com/wiki/images/6/61/Image55.png)
...
![Image56.png](https://suitecrm.com/wiki/images/9/9b/Image56.png)
...
![Image57.png](https://suitecrm.com/wiki/images/0/02/Image57.png)
...
![Image58.png](https://suitecrm.com/wiki/images/b/bc/Image58.png)
...
![Image59.png](https://suitecrm.com/wiki/images/1/17/Image59.png)
...
![Image60.png](https://suitecrm.com/wiki/images/1/11/Image60.png)
...
![Image61.png](https://suitecrm.com/wiki/images/d/da/Image61.png)
...
specified in the [Mass Updating Records](#Mass_Updating_Records)
section.

![Image62.png](https://suitecrm.com/wiki/images/5/51/Image62.png)
...
![Image63.png](https://suitecrm.com/wiki/images/9/92/Image63.png)
...
![Image64.png](https://suitecrm.com/wiki/images/6/6c/Image64.png)
...
records to the primary record using the '&lt;&lt;' buttons. In this
example, we have moved the First Name and Last Name from the duplicate
record to the primary record.

![Image65.png](https://suitecrm.com/wiki/images/c/c8/Image65.png)
...
![Image66.png](https://suitecrm.com/wiki/images/1/17/Image66.png)
...
![Image67.png](https://suitecrm.com/wiki/images/b/b1/Image67.png)
...
-   Sample .csv file for easier import of data — Use the available
    sample .csv file as a template for import of files
-   Retain settings from previous imports — Save/preserve import file
    properties, mappings, and duplicate check indexes from previous
    imports for ease of current data import process
-   Ability to accept both database name and display labels of drop-down
    and multi-select field items — Field labels as well as database
    names are accepted and mapped during import, but only the field
    labels are displayed for ease of use
-   Ability to accept both usernames and full names in user fields
    during import and export of data — Full names of Users displayed for
    Assigned To and other User-related fields in exported .csv file for
    easier identification of user records
-   Ability to auto-detect file properties in import file — Upload
    import files without specifying file properties such as tab, comma,
    double and single quotes, date and time formats, making the process
    simpler and faster
...
*Note: Always import the Account data first and then import Contacts and
...
4.  Optionally, download the available template, delete the existing
    data, input your data and upload to this page using the Browse
    button.
5.  Click Next.
...
8.  Click View Import File Properties button to verify and change the
    data as needed, if you notice irregularities in the Confirm Import
...
18. Step 4 also provides the option of saving the current import file
    properties, mappings, and duplicate check indexes for future
    imports.
...
[Importing Records](#Importing_Records) section of the user guide.

*Note: When exporting values from drop-down lists, SuiteCRM exports the
...
*Note: In-line editing can be enabled/disabled for both List View and
Detail View. This can be done in the main System Settings for the CRM,
by the System Administrator.*

![Image68.png](https://suitecrm.com/wiki/images/2/26/Image68.png)
...
![Image69.png](https://suitecrm.com/wiki/images/4/4d/Image69.png)

You can either click on the pencil icon, or double click on the field to
edit the value.

![Image70.png](https://suitecrm.com/wiki/images/1/1e/Image70.png)
...
![Image71.png](https://suitecrm.com/wiki/images/3/37/Image71.png)
...
![Image73.png](https://suitecrm.com/wiki/images/0/08/Image73.png)
...
![Image74.png](https://suitecrm.com/wiki/images/1/1a/Image74.png)
...
*Note: Users will have to enable desktop notifications on all browsers
and computers if you use more than one.*

![Image75.png](https://suitecrm.com/wiki/images/2/25/Image75.png)

Once desktop notifications have been enabled, users will receive
notifications for any Calendar events such as:

-   Meetings – Meetings you have been invited to that have popup
    reminders set.
-   Calls – Calls you have been invited to that have popup reminders
    set.
...
![Image76.png](https://suitecrm.com/wiki/images/b/b9/Image76.png)
...
![Image77.png](https://suitecrm.com/wiki/images/a/a1/Image77.png)

You can manage your desktop notifications by clicking the icon which
will show any existing notifications.

![Image78.png](https://suitecrm.com/wiki/images/b/b4/Image78.png)
...
-   View Accounts – Once clicked, you will be redirected to the List
    View for the Accounts module. This allows you to search and list
    Accounts records.
-   Import Accounts – Redirects you to the Import Wizard for the
    Accounts module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating an Account, See
[Accounts Field List](#Accounts_Field_List).
...
-   To sort records on the Accounts List View, click any column title
    ...
    descending.
-   To search for a Account, see the [Search](#Search) section of this
    user guide.
-   To update some or all the Accounts on the List View, use the Mass
    Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Account, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To merge duplicate Accounts, select the records from the Accounts
    List View, click the Merge link in the Actions drop-down list, and
    progress through the merge process. For more information on Merging
    Duplicates, see the [Merging Records](#Merging_Records) section of
    this user guide.
-   To delete one or multiple Accounts, you can select multiple records
    from the List View and click delete. you can also delete a Account
    from the Detail View by clicking the Delete button. For a more
    detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To edit the Account details, click Edit icon within the List View or
    click the edit button on the Detail View, make the necessary
    changes, and click Save.
-   For a detailed guide on importing and exporting Accounts, see the
    [Importing Records](#Importing_Records) and [Exporting
    Records](#Exporting_Records) sections of this user guide.
-   To track all changes to audited fields, in the Account record, you
    can click the View Change Log button on the Account's Detail View or
    Edit View.
...
-   Import Contacts – Redirects you to the Import Wizard for the
    Contacts module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating an Contact, See
[Contacts Field List](#Contacts_Field_List).
...
-   To sort records on the Contacts List View, click any column title
    which is sortable. This will sort the column either ascending or
    descending.
-   To search for a Contact, see the [Search](#Search) section of this
    user guide.
...
-   To duplicate a Contact, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To merge duplicate Contacts, select the records from the Contacts
    List View, click the Merge link in the Actions drop-down list, and
    progress through the merge process. For more information on Merging
    Duplicates, see the [Merging Records](#Merging_Records) section of
    this user guide.
-   To delete one or multiple Contacts, you can select multiple records
    from the List View and click delete. You can also delete a Contact
    from the Detail View by clicking the Delete button. For a more
    detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   For a detailed guide on importing and exporting Contacts, see the
    [Importing Records](#Importing_Records) and [Exporting
    Records](#Exporting_Records) sections of this user guide.
-   To track all changes to audited fields, in the Contact record, you
    can click the View Change Log button on the Contact's Detail View or
    Edit View.
...
-   Create Opportunity – A new form is opened in Edit View to allow you
...
-   Import Opportunities – Redirects you to the Import Wizard for the
    Opportunities module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating an Opportunity,
See [Opportunities Field List](#Opportunities_Field_List).

### Managing Opportunities

-   To sort records on the Opportunities List View, click any column
    title which is sortable. This will sort the column either ascending
    or descending.
-   To search for a Opportunity, see the [Search](#Search) section of
    this user guide.
-   To update some or all the Opportunities on the List View, use the
    Mass Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Opportunity, you can click the Duplicate button on
    the Detail View and then save the duplicate record.
-   To merge duplicate Opportunities, select the records from the
    Opportunities List View, click the Merge link in the Actions
    drop-down list, and progress through the merge process. For more
    information on Merging Duplicates, see the [Merging
    Records](#Merging_Records) section of this user guide.
-   To delete one or multiple Opportunities, you can select multiple
    ...
    Opportunity from the Detail View by clicking the delete button. For
    a more detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To edit the Opportunity details, click the Edit icon within the List
    ...
    changes, and click Save.
-   For a detailed guide on importing and exporting Opportunities, see
    the [Importing Records](#Importing_Records) and [Exporting
    Records](#Exporting_Records) sections of this user guide.
-   To track all changes to audited fields, in the Opportunity record,
    you can click the View Change Log button on the Opportunities Detail
    View or Edit View.
...
-   Create Lead – A new form is opened in Edit View to allow you to
    create a new Account record.
-   View Leads – Redirects you to the List View for the Leads module.
    This allows you to search and list Lead records.
-   Import Leads – Redirects you to the Import Wizard for the Leads
    module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating a Lead, See
[Leads Field List](#Leads_Field_List).

### Managing Leads

-   To sort records on the Leads List View, click any column title which
    is sortable. This will sort the column either ascending or
    descending.
-   To search for a Leads, see the [Search](#Search) section of this
    user guide.
-   To update some or all the Leads on the List View, use the Mass
    Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Lead, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To merge duplicate Leads, select the records from the Leads List
    View, click the Merge link in the Actions drop-down list, and
    progress through the merge process. For more information on Merging
    Duplicates, see the [Merging Records](#Merging_Records) section of
    this user guide.
-   To delete one or multiple Leads, you can select multiple records
    from the List View and click delete. you can also delete a Lead from
    the Detail View by clicking the Delete button. For a more detailed
    guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To track all changes to audited fields, in the Lead record, you can
    click the View Change Log button on the Lead Detail View or Edit
    View.
...
on the arrow next to the Edit button, then click on 'Convert Lead' from
the drop-down menu shown in the image below:

![Convert Leads.png](https://suitecrm.com/wiki/images/0/0a/Convert_Leads.png)

If an Admin has amended the System Settings to disable actions within
menus then to Convert a Lead you will have to again click the individual
Lead record to access the Lead Detail View but this time click on the
Convert Lead button as shown below:

![Convert Lead Alternative.png](https://suitecrm.com/wiki/images/d/d1/Convert_Lead_Alternative.png)
...
![Convert to Contact.png](https://suitecrm.com/wiki/images/e/e2/Convert_to_Contact.png)
...
![Convert to Account.png](https://suitecrm.com/wiki/images/a/af/Convert_to_Account.png)
...
![Convert to Opportunity.png](https://suitecrm.com/wiki/images/e/e9/Convert_to_Opportunity.png)
...
![Convert other Options.png](https://suitecrm.com/wiki/images/a/ad/Convert_other_Options.png)
...
![Duplicate Warning.png](https://suitecrm.com/wiki/images/9/95/Duplicate_Warning.png)
...
-   Schedule Meetings – A new form is opened in the Edit View of the
    Meetings module to allow you to create a new Meeting record. This
    record will display on the Calendar.
...
-   Log Call – A new form is opened in Edit View to allow you to create
    a new Call record.
-   View Calls – Redirects you to the List View for the Calls module.
    This allows you to search and list Call records.
...
[Calls Field List](#Calls_Field_List).
...
-   To sort records on the Calls List View, click any column title which
    is sortable. This will sort the column either ascending or
    descending.
-   To search for a Call, see the [Search](#Search) section of this user
    guide.
-   To update some or all of the Calls on the List View, use the Mass
    Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Call, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To close a Call, click on the 'x' icon on the Calls List View. You
    can also close a Call by clicking the Close button on the Detail
    View of a Call. You can also click the Close and Create New button.
    This will close the Call you are viewing and redirect you to the
    Edit View to create a new record.
-   To Reschedule a call, you can click the Reschedule button on the
    Detail View of a Call. For a detailed guide on rescheduling calls,
    see the [Reschedule](#Reschedule) section of this user guide.
-   To delete one or multiple Calls, you can select multiple records
    from the List View and click delete. You can also delete a Call from
    the Detail View by clicking the Delete button. For a more detailed
    guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To track all changes to audited fields, in the Call record, you can
    click the View Change Log button on the Call Detail View or Edit
    View.
...
-   Import Meetings – Redirects you to the Import Wizard for the
    Meetings module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating scheduling a
Meeting, See [Meetings Field List](#Meetings_Field_List).
...
-   To sort records on the Meetings List View, click any column title
    which is sortable. This will sort the column either ascending or
    descending.
-   To search for a Meeting, see the [Search](#Search) section of this
    user guide.
...
-   To close a Meeting, click on the 'x' icon on the Meetings List View.
    You can also close a Meeting by clicking the Close button on the
    Detail View of a Meeting. You can also click the Close and Create
    New button. This will close the Meeting you are viewing and redirect
    you to the Edit View to create a new record.
-   To Reschedule a Meeting, you can click the Reschedule button on the
    Detail View of a Meeting. For a detailed guide on rescheduling
    Meetings, see the [Reschedule](#Reschedule) section of this user
    guide.
-   To delete one or multiple Meetings, you can select multiple records
    from the List View and click delete. You can also delete a Meeting
    from the Detail View by clicking the Delete button. For a more
    detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
-   To view the details of a Meeting, click the Meeting Subject in the
    List View. This will open the record in Detail View.
-   To edit the Meeting details, click the Edit icon within the List
    View or click the edit button on the Detail View, make the necessary
    changes, and click Save.
-   For a detailed guide on importing and exporting Meeting, see the
    Import and Export [Importing Records](#Importing_Records) and
    [Exporting Records](#Exporting_Records) sections of this user guide.
-   To track all changes to audited fields, in the Meeting record, you
    can click the View Change Log button on the Meeting's Detail View or
    Edit View.
...
-   View My Email – Redirects you to your mailbox so that you can view
    and manage emails displayed/imported to the CRM.
-   Create Email Template - A WYSIWYG editor where you can create Emails
    by dragging and dropping components, inserting variables and
    amending the plain text.
...
[Emails Field List](#Emails_Field_List).
...
-   Create Task – A new form is opened in Edit View to allow you to
    create a new Task record.
-   View Tasks – Redirects you to the List View for the Tasks module.
    This allows you to search and list Task records.
...
[Tasks Field List](#Tasks_Field_List).
...
-   To sort records on the Tasks List View, click any column title which
    is sortable. This will sort the column either ascending or
    descending.
-   To search for a Task, see the [Search](#Search) section of this user
    guide.
-   To update some or all of the Task on the List View, use the Mass
    Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Task, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To close a Task, click on the 'x' icon on the Tasks List View. You
    can also close a Meeting by clicking the Close button on the Detail
    View of a Task. You can also click the Close and Create New button.
    This will close the Task you are viewing and redirect you to the
    Edit View to create a new record.
-   To delete one or multiple Tasks, you can select multiple records
    from the List View and click delete. You can also delete a Task from
    the Detail View by clicking the Delete button. For a more detailed
    guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To track all changes to audited fields, in the Task record, you can
    click the View Change Log button on the Task's Detail View or Edit
    View.
...
-   Create Note or Attachment – A new form is opened in Edit View to
    allow you to create a new Note record (with attachment).
-   View Notes – Redirects you to the List View for the Notes module.
    This allows you to search and list Note records.
-   Import Notes – Redirects you will be taken to the Import Wizard for
    the Notes module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating a Note, See
[Notes Field List](#Notes_Field_List).
...
-   To sort records on the Notes List View, click any column title which
    is sortable. This will sort the column either ascending or
    descending.
-   To search for a Note, see the [Search](#Search) section of this user
    guide.
-   To update some or all the Notes on the List View, use the Mass
    Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Note, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To delete one or multiple Notes, you can select multiple records
    from the List View and click delete. You can also delete a Note from
    the Detail View by clicking the Delete button. For a more detailed
    guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To track all changes to audited fields, in the Note record, you can
    click the View Change Log button on the Note's Detail View or Edit
    View.
...
[Documents Field List](#Documents_Field_List).
...
-   To sort records on the Documents List View, click any column title
    which is sortable. This will sort the column either ascending or
    descending.
-   To search for a Document, see the [Search](#Search) section of this
    user guide.
...
-   To delete one or multiple Documents, you can select multiple records
    from the List View and click delete. You can also delete a Document
    from the Detail View by clicking the Delete button. For a more
    detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
-   To view the details of a Document, click the Document Name in the
    List View. This will open the record in Detail View.
-   To view an attachment, click the attachment link on the List View or
    ...
    Document Revision.
-   To edit the Document details, click Edit icon within the List View
    or click the edit button on the Detail View, make the necessary
    changes, and click Save.
...
-   To track all changes to audited fields, in the Document record, you
    can click the View Change Log button on the Document's Detail View
    or Edit View.
...
-   View Targets – Redirects you to the List View for the Targets
    module. This allows you to search and list Target records.
-   Import Targets – Redirects you will be taken to the Import Wizard
    for the Targets module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating a Target, See
[Targets Field List](#Targets_Field_List).

### Managing Targets

-   To sort records on the Targets List View, click any column title
    which is sortable. This will sort the column either ascending or
    descending.
-   To search for a Target, see the [Search](#Search) section of this
    user guide.
...
-   To delete one or multiple Targets, you can select multiple records
    from the List View and click delete. You can also delete a Target
    from the Detail View by clicking the Delete button. For a more
    detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   For a detailed guide on importing and exporting Targets, see the
    [Importing Records](#Importing_Records) and [Exporting
    Records](#Exporting_Records) sections of this user guide.
-   To track all changes to audited fields, in the Target record, you
    can click the View Change Log button on the Target's Detail View or
    Edit View.
...
-   Create Target List – A new form is opened in Edit View to allow you
    to create a new Target List record.
-   View Target Lists – Redirects you to the List View for the Target
    Lists module. This allows you to search and list Target List
    records.

To view the full list of fields available when creating a Target List,
See [Target Lists Field List](#Target_Lists_Field_List).
...
-   To sort records on the Target List List View, click any column title
    which is sortable. This will sort the column either ascending or
    descending.
-   To search for a Target List, see the [Search](#Search) section of
    this user guide.
-   To update some or all the Target Lists on the List View, use the
    Mass Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Target List, you can click the Duplicate button on
    the Detail View and then save the duplicate record.
-   To delete one or multiple Target Lists, you can select multiple
    records from the List View and click delete. You can also delete a
    Target List from the Detail View by clicking the Delete button. For
    a more detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
-   To view the details of a Target List, click the Target List Name in
    the List View. This will open the record in Detail View.
-   To edit the Target List details, click Edit icon within the List
    View or click the edit button on the Detail View, make the necessary
    changes, and click Save.
-   For a detailed guide on importing and exporting Target Lists, see
    the [Importing Records](#Importing_Records) and [Exporting
    Records](#Exporting_Records) sections of this user guide.
...
-   View Diagnostics – Allows you to check that your Campaign Emails and
    ...
    green tick icon will appear, if there are any issues with the setup
    then a red cross icon will appear and you should contact your Admin
    for assistance.
-   Create Person Form – A web form template Wizard allowing you to
    create Leads, Contacts and Targets.
-   To view the full list of fields available when creating a Campaign,
    See [Campaign Fields List](#Campaign_Fields_List).
...
![Create Campaign Module DD.png](https://suitecrm.com/wiki/images/9/9f/Create_Campaign_Module_DD.png)
...
![Campaign Wizard.png](https://suitecrm.com/wiki/images/0/04/Campaign_Wizard.png)
...
![Newsletter Campaign Header.png](https://suitecrm.com/wiki/images/a/ad/Newsletter_Campaign_Header.png)

Once you have completed the necessary fields and are ready to progress
to the next stage then click Next.

![Next.png](https://suitecrm.com/wiki/images/c/c4/Next.png)
...
![Newsletter Subscriptions.png](https://suitecrm.com/wiki/images/4/4f/Newsletter_Subscriptions.png)
...
-   The Subscription List - Allows you to set a Target List for your
    ...
    Campaign. If you have not already created a Target List then an
    empty list will be created for you and you can set this at a later
    time.
-   The Unsubscription List - Allows you to set a Target List of
    ...
    contacted through email. If you have not already created a Target
    List then an empty list will be created for you and you can set this
    at a later time.
-   The Test List - Allows you to set a Target List to send out test
    emails for this Campaign. If you have not already created a Target
    List then an empty list will be created for you and you can set this
    at a later time.
...
![Campaign Target Lists.png](https://suitecrm.com/wiki/images/4/47/Campaign_Target_Lists.png)

Recipients that have previously opted out of your marketing Campaigns
will automatically be removed from your Target List.

![Campaign New Target List.png](https://suitecrm.com/wiki/images/9/92/Campaign_New_Target_List.png)
...
[Target Lists](#Target_Lists) page. The next step for non-email based
Campaigns is the [Campaign Summary](#Campaign_Summary) page, Email based
Campaigns however should move onto the Campaign Templates page.

### Campaign Wizard Templates

![Newsletter
Templates.png](https://suitecrm.com/wiki/images/5/5e/Newsletter_Templates.png)

This page is a WYSIWYG Newsletter Template editor so you can create a
template for your marketing emails.

![Newsletter Email
Template.png](https://suitecrm.com/wiki/images/8/86/Newsletter_Email_Template.png)
...
-   Select an existing template – You can select from a drop down list
    of existing Email Templates
-   Create a brand new template – If you wish to start the Newsletter
    from scratch then you can select this option.
-   Copy an existing template – Allows you select an existing template
    and use this as a base to make amendments
...
![Email Tracker
URLs.png](https://suitecrm.com/wiki/images/d/d3/Email_Tracker_URLs.png)
...
![Email
Variables.png](https://suitecrm.com/wiki/images/0/0c/Email_Variables.png)
...
![Email WYSIWIG
Editor.png](https://suitecrm.com/wiki/images/a/a4/Email_WYSIWIG_Editor.png)
...
![Email Template
Editor.png](https://suitecrm.com/wiki/images/3/36/Email_Template_Editor.png)
...
![Newsletter
Marketing.png](https://suitecrm.com/wiki/images/b/ba/Newsletter_Marketing.png)
...
![Newsletter Summary Review.png](https://suitecrm.com/wiki/images/5/5a/Newsletter_Summary_Review.png)
...
-   Send Mail at Scheduled Time – You can click this once you are sure
    all sections of the Campaign are set correctly and are confident
    that it is the finished article.
-   Send Marketing Email as Test – This option gives you the opportunity
    to send out your Campaign to your Test List that you specified in
    the Subscriptions section of the Campaign Wizard. By doing this you
    can view the Campaign as a recipient and double check that the
    Campaign appears as it should do before sending out to real
    prospective/live customers.
-   View Details – By clicking this option you are taken to the Detail
    View of the Campaign record you have just created through the
    Newsletter Campaign Wizard.
...
![Campaign Create Person Form.png](https://suitecrm.com/wiki/images/7/7a/Campaign_Create_Person_Form.png)

Once you have clicked this, you will be taken to the first page of the
Create Person Form Wizard.

![Campaign Person Fields.png](https://suitecrm.com/wiki/images/5/54/Campaign_Person_Fields.png)
...
![Campaign Create Person Additional Info.png](https://suitecrm.com/wiki/images/8/89/Campaign_Create_Person_Additional_Info.png)
...
![Campaign Create Person Editor.png](https://suitecrm.com/wiki/images/e/e0/Campaign_Create_Person_Editor.png)
...
![Campaign Person
Link.png](https://suitecrm.com/wiki/images/e/e9/Campaign_Person_Link.png)
...
![Campaign
Status.png](https://suitecrm.com/wiki/images/4/4f/Campaign_Status.png)
...
![Campaign Response
Tracking.png](https://suitecrm.com/wiki/images/8/85/Campaign_Response_Tracking.png)
...
![Campaign Viewed
Message.png](https://suitecrm.com/wiki/images/8/86/Campaign_Viewed_Message.png)
...
![Campaign ROI
Graph.png](https://suitecrm.com/wiki/images/1/16/Campaign_ROI_Graph.png)
...
-   Create Case – A new form is opened in Edit View to allow you to
    create a new Account record.
-   View Cases – Redirects you to the List View for the Cases module.
    This allows you to search and list Case records.
-   Import Cases – Redirects you will be taken to the Import Wizard for
    the Cases module. For more information, see [Importing
    Records](#Importing_Records).

To view the full list of fields available when creating a Case, See
[Cases Field List](#Cases_Field_List).

Advanced functionality for Cases can be found in the [Advanced
Cases](#Advanced_Open_Cases_with_Portal) section of this User Guide.
...
-   To sort records on the Cases List View, click any column title which
    is sortable. This will sort the column either ascending or
    descending.
-   To search for a Case, see the [Search](#Search) section of this user
    guide.
-   To update some or all the Cases on the List View, use the Mass
    Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
-   To duplicate a Case, you can click the Duplicate button on the
    Detail View and then save the duplicate record.
-   To merge duplicate Cases, select the records from the Cases List
    View, click the Merge link in the Actions drop-down list, and
    progress through the merge process. For more information on Merging
    Duplicates, see the [Merging Records](#Merging_Records) section of
    this user guide.
-   To delete one or multiple Cases, you can select multiple records
    from the List View and click delete. You can also delete a Case from
    the Detail View by clicking the Delete button. For a more detailed
    guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
...
-   To track all changes to audited fields, in the Case record, you can
    click the View Change Log button on the Case's Detail View or Edit
    View.
...
-   View Project – Redirects you to the List View for the Projects
    module. This allows you to search and list Project records.
...
[Projects Field List](#Projects_Field_List).
...
2.  On the Projects page, enter information for the following fields:
    ...
    2.  Status. From the drop-down list, select the Project status such
        as Draft, In Review, or Published.
    3.  Start Date. Click the Calendar icon and select the Project start
        date.
    4.  End Date. Click the Calendar icon and select the Project end
        date.
    5.  Assigned to. Enter the name of you who has ownership of the
        Project. By default, it is assigned to you.
...
2.  On the Project Tasks page, enter information for the following
    ...
    2.  Task ID. Enter a numerical value as the task identification
        number.
    3.  Start Date. Click the Calendar icon and select the date when the
        task is due to begin.
    4.  Finish Date. Click the Calendar icon and select a date when the
        task is due to be completed; enter the start time in the
        adjoining field.
    ...
    8.  Project Name. Click Select and choose the project associated
        with the task.
...
-   To search for a Project or Project task, see the [Search](#Search)
    section of this user guide.
-   To update some or all the Projects or Project Tasks on the List
    View, use the Mass Update panel as described in the [Mass Updating
    Records](#Mass_Updating_Records) section of this user guide.
...
-   To delete one or multiple Projects, you can select multiple records
    from the List View and click delete. You can also delete a Project
    from the Detail View by clicking the Delete button. For a more
    detailed guide on deleting records, see the [Deleting
    Records](#Deleting_Records) section of this user guide.
-   To view the details of a Project or Project Task, click the Project
    or Project Task Name in the List View. This will open the record in
    Detail View.
...
-   For a detailed guide on importing and exporting Projects and Project
    Tasks, see the [Importing Records](#Importing_Records) and
    [Exporting Records](#Exporting_Records) sections of this user guide.
-   To track all changes to audited fields, in the Project or Project
    Task record, you can click the View Change Log button on the
    Project's or Project Task's Detail View or Edit View.
...
![Image79.png](https://suitecrm.com/wiki/images/7/79/Image79.png)
...
-   Enable Line Items Groups – If selected then users will be able to
    bundle line items into groups. If this is not selected then you will
    not be able to use the AOS Group functionality. *Note: This setting
    should be selected before using AOS – It is difficult to migrate
    from/to groups once Quotes/Invoices have been created.*
-   Add Tax to Line Total – If this is selected then the Tax will be
    added into the Line Total on Line Items. If this is not the selected
    the Line Total will not include Tax.

![Image80.png](https://suitecrm.com/wiki/images/f/f9/Image80.png)
...
![Image81.png](https://suitecrm.com/wiki/images/0/0e/Image81.png)
...
![Image82.png](https://suitecrm.com/wiki/images/6/6b/Image82.png)
...
![Image83.png](https://suitecrm.com/wiki/images/7/77/Image83.png)
...
'pdf\_template\_type\_dom' using the drop down editor functionality.
Please note that the drop down 'Item Name' must be the name of the
module directory.
...
![Image84.png](https://suitecrm.com/wiki/images/7/79/Image84.png)
...
![Image85.png](https://suitecrm.com/wiki/images/b/bb/Image85.png)
...
![Image86.png](https://suitecrm.com/wiki/images/c/c3/Image86.png)
...
![Image87.png](https://suitecrm.com/wiki/images/0/0b/Image87.png)
...
![Image88.png](https://suitecrm.com/wiki/images/b/b8/Image88.png)
...
![Image89.png](https://suitecrm.com/wiki/images/9/93/Image89.png)
...
![Image90.png](https://suitecrm.com/wiki/images/1/1a/Image90.png)

Clicking the 'Generate Letter' button found on these modules Detail View
will prompt a pop-up asking to select a template.

![Image91.png](https://suitecrm.com/wiki/images/e/ea/Image91.png)
...
![Image92.png](https://suitecrm.com/wiki/images/8/82/Image92.png)
...
![Image93.png](https://suitecrm.com/wiki/images/5/56/Image93.png)
...
![Image94.png](https://suitecrm.com/wiki/images/5/5b/Image94.png)
...
*Note: Add Group will be displayed if “Enable Line Item groups” is
selected in Admin.*

![Image95.png](https://suitecrm.com/wiki/images/a/a1/Image95.png)
...
![Image96.png](https://suitecrm.com/wiki/images/4/45/Image96.png)
...
![Image97.png](https://suitecrm.com/wiki/images/2/2f/Image97.png)
...
![Image98.png](https://suitecrm.com/wiki/images/c/c9/Image98.png)
...
![Image99.png](https://suitecrm.com/wiki/images/0/03/Image99.png)
...
![Image100.png](https://suitecrm.com/wiki/images/1/1f/Image100.png)

AOS will also keep a Grand Total for all Groups combined.

![image101.png](https://suitecrm.com/wiki/media/image101.png)](https://suitecrm.com/wiki/index.php/MediaWiki)
...
![image102.png](https://suitecrm.com/wiki/media/image102.png)](https://suitecrm.com/wiki/index.php/MediaWiki)

AOS provides users with three methods of sending Quotes:


-   Print as PDF – Allows you to select a template and download or save
    a PDF of the Quote.
-   Email PDF – Allows you to select a template then directs you to the
    SuiteCRM email client 'Compose' screen. The Quote PDF will be
    attached to email and the email will be addressed to the related
    Contact of the Quote. This allows you to fill out the email body.
-   Email Quotation – This directs you to the SuiteCRM email client
    'Compose' screen. The email will be addressed to the related Contact
    of the Quote. There will be no attachment and the Quote will be
...
![image103.png](https://suitecrm.com/wiki/media/image103.png)](https://suitecrm.com/wiki/index.php/MediaWiki)
...
![image104.png](https://suitecrm.com/wiki/media/image104.png)](https://suitecrm.com/wiki/index.php/MediaWiki)
...
![image105.png](https://suitecrm.com/wiki/media/image105.png)
...
![image106.png](https://suitecrm.com/wiki/media/image106.png)
...
![image107.png](https://suitecrm.com/wiki/media/image107.png)

AOS provides users with three methods of sending Invoices:


-   Print as PDF – Allows users to select a template and download or
    save a PDF of the Invoice.
-   Email PDF – Allows users to select a template then directs you to
    the SuiteCRM email client 'Compose' screen. The Invoice PDF will be
    attached to email and the email will be addressed to the related
    Contact of the Invoice. This allows user to fill out the email body.
-   Email Invoice – This directs you to the SuiteCRM email client
    'Compose' screen. The email will be addressed to the related Contact
    of the Invoice. There will be no attachment and the Invoice will be
    displayed within the body of the email.
...
![image108.png](https://suitecrm.com/wiki/media/image108.png)
...
![image109.png](https://suitecrm.com/wiki/media/image109.png)
...
-   WorkFlow Module – A drop down list of all the modules found within
    the SuiteCRM instance. This is the module the workflow is run
    against. For example, When an Account is created/edited.
...
-   Repeated Runs – If checked, the process will continue to run over
    and over. Ideally this should only be checked if one of the
    specified Actions negates (or will lead to the negation) of one of
...
![image110.png](https://suitecrm.com/wiki/media/image110.png)

To add a Condition Line you must click the 'Add Condition' button.

*Note: You must select your WorkFlow Module on the first panel before
adding a Condition Line.*

![image111.png](https://suitecrm.com/wiki/media/image111.png)
...
![image112.png](https://suitecrm.com/wiki/media/image112.png)
...
![image113.png](https://suitecrm.com/wiki/media/image113.png)
...
![image114.png](https://suitecrm.com/wiki/media/image114.png)

Field – This is used to action a workflow process when one field is
compared to another field in the record.

![image115.png](https://suitecrm.com/wiki/media/image115.png)
...
![image116.png](https://suitecrm.com/wiki/media/image116.png)
...
![image117.png](https://suitecrm.com/wiki/media/image117.png)
...
![image118.png](https://suitecrm.com/wiki/media/image118.png)
...
![image119.png](https://suitecrm.com/wiki/media/image119.png)

This will cause the Action Line to appear.

![image120.png](https://suitecrm.com/wiki/media/image120.png)
...
-   Value – This will allow you to input the value directly using the
    same field type as the field selected.
...
-   Date – Only selectable if the field is a date field. This will allow
    you to specify the value as an amount of time after/before another
    date field or 'Now'.

![image123.png](https://suitecrm.com/wiki/media/image123.png)
...
![image124.png](https://suitecrm.com/wiki/media/image124.png)
...
![image125.png](https://suitecrm.com/wiki/media/image125.png)

*Note: You must selected the related module using the arrow button – The
...
![image126.png](https://suitecrm.com/wiki/media/image126.png)
...
![image127.png](https://suitecrm.com/wiki/media/image127.png)
...
![image128.png](https://suitecrm.com/wiki/media/image128.png)
...
![image129.png](https://suitecrm.com/wiki/media/image129.png)


#### [Calculate Fields]{#Calculate_Fields .mw-headline}
...
[![AddActionCF\_updated.png](https://suitecrm.com/wiki/images/5/5a/AddActionCF_updated.png)
...
[![AddActionCF\_updated1.png](https://suitecrm.com/wiki/images/f/f2/AddActionCF_updated1.png)
...
{Px} where x is the sequential order of the parameter. The amount of the
...
[![AddAction\_updated2.png](https://suitecrm.com/wiki/images/8/86/AddAction_updated2.png)
...
parameters are like {Rx} where x is the sequential order of the relation
parameter. The amount of the relation parameters is not limited.
...
[![AddActionCF\_updated3.png](https://suitecrm.com/wiki/images/4/40/AddActionCF_updated3.png)
...
sections, if we fill the formula like: Account {P0} created by user name
{R0}, then the description field will have the following value after
save: Account My Account created by user name MyUser (implying the
...
``` {style="white-space: pre; white-space: -moz-pre; white-space: -pre; white-space: -o-pre;"}
...
##### [Logical Functions]{#Logical_Functions .mw-headline}
...
Description
Determines if **parameter1** equals
with **parameter2**

Returns
1 if the two parameters are equal or 0 if
not
...
parameter2: can be any value of any type
Description
Determines if **parameter1** not
equals with **parameter2**

Returns
0 if the two parameters are equal or 1 if
not
...
parameter2: can be any value of any type
Description
Determines if **parameter1** greater
than **parameter2**

Returns
1 if **parameter1** greater than
**parameter2**, 0 if not
...
Description
Determines if **parameter1** greater
than or equal **parameter2**

Returns
1 if **parameter1** greater than or
equal **parameter2**, 0 if not
...
parameter2: can be any value of any type
Description
Determines if **parameter1** less than
**parameter2**

Returns
1 if **parameter1** less than
**parameter2**, 0 if not
...
Returns
1 if **parameter1** less than or equal
**parameter2**, 0 if not
...
| Parameters                        | parameter: text value             |
+-+-+
| Description                       | Determines if **parameter** is    |
|                                   | not                               |
|                                   | empty                             |
+-+-+
| Returns                           | 1 if **parameter** is not empty,  |
|                                   | 0 if                              |
|                                   | empty                             |
+-+-+
...
+-+-+
| Description                       | Negates the logical value of the  |
|                                   | **parameter**                     |
+-+-+
| Returns                           | 1 if **parameter** is 0, 0 if     |
|                                   | **parameter** is 1                |
+-+-+
...
Description
Applies the AND logical operator to two
logical values

Returns
1 if **parameter1** and **parameter2**
is 1, 0 if any parameters are 0
...
parameter2: logical value
Description
Applies the OR logical operator to two
logical values

Returns
1 if **parameter1** or **parameter2**
is 1, 0 if both parameters are 0

Example call
{or(1; 0)} returns 1
##### [Text Functions]{#Text_Functions .mw-headline}
...
If the **length** optional parameter is not set, then it cuts all
characters until the end of the string, otherwise cuts the provided
**length**. Indexing of a text’s characters starting from 0.
...
|                                   | search: text value                |
+-+-+
| Description                       | Find position of first occurrence |
|                                   | of                                |
|                                   | **search** in a **subject**       |
+-+-+
| Returns                           | Numeric position of **search** in |
|                                   | **subject** or -1 if **search**   |
|                                   | not present in **subject**        |
+-+-+
| Example call                      | {position(Where is my text?;      |
|                                   | text)}                            |
|                                   | returns 12                        |
+-+-+
...
+-+-+
| Example call                      | {lowercase(ThIs iS a sAmPlE       |
|                                   | tExT)}                            |
...
+-+-+
| Example call                      | {uppercase(ThIs iS a sAmPlE       |
|                                   | tExT)}                            |
|                                   | returns THIS IS A SAMPLE TEXT     |
+-+-+

##### [Mathematical functions]{#Mathematical_functions .mw-headline}
...
parameter2: number value
Description
Subtracts **parameter2** from
**parameter1**

Returns
The distinction of **parameter2** and
**parameter1**
...
parameter2: number value
Description
Multiplies **parameter1** and
**parameter2**

Returns
The product of **parameter1** and
**parameter2**
...
Returns
The division of **parameter2** and
**parameter1**
...
parameter2: number value
Description
Raises **parameter1** to the power of
**parameter2**

Returns
**parameter1** raised to the power of
**parameter2**
...
| Parameters                        | parameter: number value           |
+-+-+
| Description                       | Calculates the absolute value of  |
|                                   | **parameter**                     |
+-+-+
...
##### [Date functions]{#Date_functions .mw-headline}
...
N
ISO-8601 numeric representation of the
day of the week
...
o
ISO-8601 year number. This has the same
...
l
Whether or not the date is in daylight
saving time
...
+0200
P
Difference to Greenwich time (GMT) with
...
r
[RFC 2822](//tools.ietf.org/html/rfc2822)
formatted date
...
+-+-+
| Description                       | Creates the actual date/time in   |
|                                   | the given                         |
|                                   | format                            |
+-+-+
| Returns                           | Current date/time in the given    |
|                                   | **format**                        |
+-+-+
| Example call                      | {now(Y-m-d H:i:s)} returns        |
|                                   | 2016-04-29                        |
|                                   | 15:08:03                          |
+-+-+
...
| Parameters                        | format: format text               |
+-+-+
| Description                       | Creates yesterday’s date/time in  |
|                                   | the                               |
|                                   | given format                      |
+-+-+
| Returns                           | Yesterday’s date/time in the      |
|                                   | given **format**                  |
+-+-+
| Example call                      | {yesterday(Y-m-d H:i:s)} returns  |
|                                   | 2016-04-28 15:08:03               |
+-+-+
...
| Parameters                        | format: format text               |
+-+-+
| Description                       | Creates tomorrow’s date/time in   |
|                                   | the                               |
|                                   | given format                      |
+-+-+
| Returns                           | Tomorrow’s date/time in the       |
|                                   | given **format**                  |
+-+-+
| Example call                      | {tomorrow(Y-m-d H:i:s)} returns   |
|                                   | 2016-04-30 15:08:03               |
+-+-+
...
unit:
years/months/days/hours/minutes/seconds; default: days

Description
Subtracts **timestamp2** from
**timestamp1**
...
Example call
{addYears(Ymd; 2016-04-22; 1)} returns
20170422
...
Incremented date in **format**
Example call
{addMonths(Ymd; 2016-04-22; 1)} returns
20160522
...
Incremented date in **format**
Example call
{addDays(Ymd; 2016-04-22; 1)} returns
20160423
...
Incremented date in **format**
Example call
{addHours(Ymd H:i:s; 2016-04-22 23:30;
...
Incremented date in **format**
Example call
{addMinutes(Ymd H:i:s; 2016-04-22 22:58;
5)} returns 20160422 23:03:00
...
Incremented date in **format**
Example call
{addSeconds(Ymd H:i:s; 2016-04-22 22:58;
5)} returns 20160422 22:58:05

**subtractYears**

Signature
{subtractYears(format; timestamp;
amount)}
...
amount: decimal number
Description
Subtracts **amount** years from
**timestamp**

Returns
Decremented date in **format**
Example call
{subtractYears(Ymd; 2016-04-22; 5)}
returns 20110422

**subtractMonths**

Signature
{subtractMonths(format; timestamp;
amount)}
...
amount: decimal number
Description
Subtracts **amount** months from
**timestamp**

Returns
Decremented date in **format**
Example call
{subtractMonths(Ymd; 2016-04-22; 5)}
returns 20151122
...
amount: decimal number
Description
Subtracts **amount** days from
**timestamp**

Returns
Decremented date in **format**
Example call
{subtractDays(Ymd; 2016-04-22; 5)}
returns 20160417

**subtractHours**

Signature
{subtractHours(format; timestamp;
amount)}
...
amount: decimal number
Description
Subtracts **mount** hours from
**timestamp**

Returns
Decremented date in **format**
Example call
{subtractHours(Ymd H:i:s; 2016-04-22
12:37; 5)} returns 20160422 07:37:00

**subtractMinutes**

Signature
{subtractMinutes(format; timestamp;
amount)}
...
amount: decimal number
Description
Subtracts **amount** minutes from
**timestamp**

Returns
Decremented date in **format**
Example call
{subtractMinutes(Ymd H:i:s; 2016-04-22
12:37; 5)} returns 20160422 12:32:00

**subtractSeconds**

Signature
{subtractSeconds(format; timestamp;
amount)}
...
##### [Control Functions]{#Control_Functions .mw-headline}
...
Signature
{ifThenElse(condition; trueBranch;
falseBranch)}
...
Description
Selects one of the two branches depending
on **condition**

Returns
**trueBranch** if **condition** is
true, **falseBranch** otherwise

Example call
{ifThenElse({equal(1; 1)}; 1 equals 1; 1
not equals 1)} returns 1 equals 1

##### [Counters]{#Counters .mw-headline}
...
2.  **Daily counters:** Counters which resets every day. (Starting
    from 1)
...
+-+-+
| Description                       | Increments and returns the        |
|                                   | counter for                       |
|                                   | **name** with length              |
|                                   | **numberLength**                  |
+-+-+
| Returns                           | Counter with length               |
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {GlobalCounter(myName; 4)}        |
|                                   | returns 0005                      |
+-+-+
...
+-+-+
| Signature                         | {GlobalCounterPerUser(name;       |
|                                   | numberLength)}                    |
+-+-+
| Parameters                        | name: any text                    |
+-+-+
...
| Description                       | Increments and returns the        |
|                                   | counter for                       |
|                                   | **name** for the user who creates |
|                                   | the entity with length            |
|                                   | **numberLength**                  |
+-+-+
| Returns                           | Counter with length               |
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {GlobalCounterPerUser(myName; 3)} |
|                                   | returns                           |
|                                   | 005                               |
+-+-+
...
+-+-+
| Signature                         | {GlobalCounterPerModule(name;     |
|                                   | numberLength)}                    |
+-+-+
| Parameters                        | name: any text                    |
+-+-+
...
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {GlobalCounterPerModule(myName;   |
|                                   | 2)}                               |
|                                   | returns 05                        |
+-+-+
...
+-+-+
| Signature                         | {GlobalCounterPerUserPerModule(na |
|                                   | me;                               |
|                                   | numberLength)}                    |
+-+-+
| Parameters                        | name: any text                    |
...
|                                   | counter for                       |
|                                   | **name** for the user who creates |
|                                   | the entity and for the module of  |
|                                   | the entity with length            |
|                                   | **numberLength**                  |
+-+-+
| Returns                           | Counter with length               |
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {GlobalCounterPerUserPerModule(my |
|                                   | Name;                             |
|                                   | 1)} returns 5                     |
+-+-+
...
| Returns                           | Counter with length               |
|                                   | **numberLength**,                 |
|                                   | or if the counter is not          |
|                                   | incremented this day then 1 with  |
|                                   | length **numberLength**           |
+-+-+
| Example call                      | {DailyCounter(myName; 1)} returns |
|                                   | 5                                 |
+-+-+
...
+-+-+
| Signature                         | {DailyCounterPerUser(name;        |
|                                   | numberLength)}                    |
+-+-+
| Parameters                        | name: any text                    |
+-+-+
...
|                                   | **numberLength**,                 |
|                                   | or if the counter is not          |
|                                   | incremented this day for this     |
|                                   | user then 1 with length           |
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {DailyCounter(myName; 1)} returns |
|                                   | 5                                 |
...
+-+-+
| Signature                         | {DailyCounterPerModule(name;      |
|                                   | numberLength)}                    |
+-+-+
| Parameters                        | name: any text                    |
+-+-+
...
|                                   | or if the counter is not          |
|                                   | incremented this day for this     |
|                                   | module then 1 with length         |
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {DailyCounterPerModule(myName;    |
|                                   | 1)}                               |
|                                   | returns 5                         |
+-+-+
...
+-+-+
| Signature                         | {DailyCounterPerUserPerModule(nam |
|                                   | e;                                |
|                                   | numberLength)}                    |
+-+-+
| Parameters                        | name: any text                    |
...
|                                   | **numberLength**,                 |
|                                   | or if the counter is not          |
|                                   | incremented this day for the user |
|                                   | who creates the entity and for    |
|                                   | this module then 1 with length    |
|                                   | **numberLength**                  |
+-+-+
| Example call                      | {DailyCounterPerUserPerModule(myN |
|                                   | ame;                              |
|                                   | 1)}                               |
|                                   | returns 5                         |
+-+-+
...
values: (database value in brackets) 6 months \[6\], 1 year \[12\], 2
years \[24\]. There is also a currency field called Monthly.
...
[![ExampleCF\_orig.png](https://suitecrm.com/wiki/images/4/43/ExampleCF_orig.png)
...
dropdown and add it as parameter two (it will be {P1}). There is no need
to add any relational parameters for this formula.
...
[![ExampleCF\_updated1.png](https://suitecrm.com/wiki/images/1/13/ExampleCF_updated1.png)

Save the WorkFlow and create a new Opportunity:

[![ExampleCF\_orig2.png](https://suitecrm.com/wiki/images/5/5a/ExampleCF_orig2.png)
...
[![ExampleCF\_orig3.png](https://suitecrm.com/wiki/images/4/4b/ExampleCF_orig3.png)




AOW Calculated Fields was contributed by [diligent technology & business
consulting GmbH](http://www.dtbc.eu/)
...
![image130.png](https://suitecrm.com/wiki/media/image130.png)

**Removing Field and Relationship Lines**

You can remove Field and Relationship Lines by clicking the 'X' button
on the top right hand side of the Action.

![image131.png](https://suitecrm.com/wiki/media/image131.png)
...
![image132.png](https://suitecrm.com/wiki/media/image132.png)
...
![image133.png](https://suitecrm.com/wiki/media/image133.png)
...
4.  Ensure Repeated Runs is NOT selected and the Status is Active (This
    should be done by default). Optionally you can change the
    Assigned-To and add a Description.
...
![image134.png](https://suitecrm.com/wiki/media/image134.png)
...
4.  A drop down will appear above the 'Add Relationship' button. Select
    the relationship from this drop down box. In this case we are
    looking for 'Target Lists: Prospect List'
...
![image135.png](https://suitecrm.com/wiki/media/image135.png)
...
![image136.png](https://suitecrm.com/wiki/media/image136.png)
...
![image137.png](https://suitecrm.com/wiki/media/image137.png)
...
![image138.png](https://suitecrm.com/wiki/media/image138.png)
...
4.  On the Email Line select 'Related Field' from the first drop down,
    'Users: Assigned To' from the second drop down and a email template
    from the third drop down.

Once these steps have been completed the Actions panel should look like
this:

![image139.png](https://suitecrm.com/wiki/media/image139.png)
...
![image140.png](https://suitecrm.com/wiki/media/image140.png)
...
![image141.png](https://suitecrm.com/wiki/media/image141.png)
...
![image142.png](https://suitecrm.com/wiki/media/image142.png)
...
![image143.png](https://suitecrm.com/wiki/media/image143.png)
...
6.  Select 'Subject' from the first drop down box. Leave the second drop
    down box as 'Value' then type the desired subject into the text
    field at the end.
...
11. Add another field, this time select 'Assigned-To', 'Field',
    'Assigned-To' – This will relate the assigned User of the Lead to
    the Call.
...
![image144.png](https://suitecrm.com/wiki/media/image144.png)
...
![image145.png](https://suitecrm.com/wiki/media/image145.png)
...
![image146.png](https://suitecrm.com/wiki/media/image146.png)
...
![image147.png](https://suitecrm.com/wiki/media/image147.png)
...
*Note: If you have action menus enabled the button will be within the
action menu.*

![image148.png](https://suitecrm.com/wiki/media/image148.png)](https://suitecrm.com/wiki/media/image1408png)
...
![image149.png](https://suitecrm.com/wiki/media/image149.png)
...
*Note: This feature does use the Joomla cache so please clear cache
...
![image150.png](https://suitecrm.com/wiki/media/image150.png)

To view more information on the case and to add updates then Portal
Users can click the 'Subject' of case.

![image151.png](https://suitecrm.com/wiki/media/image151.png)
...
![image152.png](https://suitecrm.com/wiki/media/image152.png)
...
![image153.png](https://suitecrm.com/wiki/media/image153.png)

The Case Detail View will show the full threaded update log.

![image154.png](https://suitecrm.com/wiki/media/image154.png)
...
name&gt;\_ItemName” For example “Open\_New” or “Closed\_Rejected”. All
values with an Item Name prefixed with “Open\_” will show when the state
is Open, similarly all with the prefix “Closed\_” will show when the
state is closed.
...
![image155.png](https://suitecrm.com/wiki/media/image155.png)
...
![image156.png](https://suitecrm.com/wiki/media/image156.png)
...
1. Hover over the Events module on the navigation bar and select 'Create
Event'.

![image157.png](https://suitecrm.com/wiki/media/image157.png)

2. This will take you to the Edit View. Enter information into the
appropriate fields, all required fields are marked with a red asterisk
and must be completed prior to saving.

![image158.png](https://suitecrm.com/wiki/media/image158.png)
...
-   **Duration** – The duration of the event. This will automatically
    change the end date or be altered automatically if the end date is
    changed.
-   **Location** – This is a relationship to the **Event Locations**
    module.
-   **Budget** – The budget for the event.
-   **Email** **Invite** **Template** – The **Email Template** that will
    be sent to associated Delegates.
-   **Accept** **Redirect** **URL** – The web page invitees should be
    redirected to after you accept an invite using the link provided in
    the **Email Template**.
-   **Decline** **Redirect** **URL** – The web page invitees should be
    redirected to after you decline an invite using the link provided in
    the **Email Template**.
...
![image159.png](https://suitecrm.com/wiki/media/image159.png)

3. Click 'Select Delegates'. A list of options will appear.

![image160.png](https://suitecrm.com/wiki/media/image160.png)

4. Select the appropriate option depending on who should be added to the
Event.

-   **Target** **List** – Select a **Target List** of individuals to be
    associated to the event. All **Targets**, **Leads** and **Contacts**
    on this **Target List** will be added to the **Event**.
-   **Targets** – Select **Targets** to be associated to this **Event**.
-   **Contacts** – Select **Contacts** to be associated to this
    **Event**.
-   **Leads** – Select **Leads** to be associated to this **Event**.
-   **Events** – Select an **Event** to associate that **Event's**
    delegates to this **Event**.

5\. Once an option has been chosen a new pop-up box will appear to search
and select records from the module type that was chosen.

6\. The Delegates sub-panel will populate with the records selected.

![image161.png](https://suitecrm.com/wiki/media/image161.png)
...
![image162.png](https://suitecrm.com/wiki/media/image162.png)
...
![image163.png](https://suitecrm.com/wiki/media/image163.png)
...
![image164.png](https://suitecrm.com/wiki/media/image164.png)

4. A list of options will appear. Select appropriate statuses:

![image165.png](https://suitecrm.com/wiki/media/image165.png)

5. This will update the Delegates 'Accept Status' accordingly.

![image166.png](https://suitecrm.com/wiki/media/image166.png)

*Note: Acceptance will my automatically updated if the Delegate chooses
...
![image167.png](https://suitecrm.com/wiki/media/image167.png)

4. A list of options will appear. Select the appropriate status;
Invited, Not Invited, Attended or Not Attended.

![image168.png](https://suitecrm.com/wiki/media/image168.png)

5. This will update the Delegates 'Status' accordingly.

![image169.png](https://suitecrm.com/wiki/media/image169.png)

*Note: Acceptance will be automatically updated if the Delegate chooses
to accept using the link provided in the email template.*
...
![image170.png](https://suitecrm.com/wiki/media/image170.png)
...
![image171.png](https://suitecrm.com/wiki/media/image171.png)
...
![image172.png](https://suitecrm.com/wiki/media/image172.png)

![image173.png](https://suitecrm.com/wiki/media/image173.png)
...
-   Display – True or false option. Allows you to specify whether this
    field should be displayed on the report, or hidden. Users may wish
    to add fields to perform a function/sort/group/total but may not
    wish to show this on the Report.
<! >

-   Link – True or false option. Allows you to make the field a link.
    Setting this option to true will hyperlink the field on the Detail
    View of the report, allowing you to click on the record. This will
    navigate you to the appropriate record. For example, linking the
    Opportunity Name will take you to the Detail View of that
    Opportunity.
<! >

-   Label – This is the label that will be displayed for the
    Column/Field on the Report. You can change the label from the
    default to any alphanumerical value.
<! >

-   Function - Provides five options: Count, Minimum, Maximum, Sum and
    Average. Allows you to perform functions on alphanumerical fields.
    Users may wish to calculate the average Opportunity Amount, or Count
    total Opportunities at a given Sales Stage.
<! >
...
-   Total – Provides three options: Count, Sum and Average. This allows
    users to perform total calculations on numerical fields. This is
    useful for financial reporting such as the total value of all
...
![image174.png](https://suitecrm.com/wiki/media/image174.png)

Once you click add chart, you will be presented with the option to
specify the following information:

-   Title – Allows the user to specify the title for the chart. This
    will show on the Detail View of the Report and also on the dashlet
    chart.
-   Type – This allows the user to select from one of the six chart
    types detailed above.
-   X Axis – Allows the user to select the column that should be used
    for the X Axis.
-   Y Axis – Allows the user to select the column that should be used
    for the Y Axis.

![image175.png](https://suitecrm.com/wiki/media/image175.png)
...
![Image176.png](https://suitecrm.com/wiki/images/1/1c/Image176.png)
...
![image177.png](https://suitecrm.com/wiki/media/image177.png)

![Image178.png](https://suitecrm.com/wiki/images/8/82/Image178.png)
...
![image179.png](https://suitecrm.com/wiki/media/image179.png)

This allows the user to select the Report they wish to display within
the dashlet.

![image180.png](https://suitecrm.com/wiki/media/image180.png)

Once you have selected the Report, click 'Save'. This will update your
Reports dashlet to show the results of the Report.

![image181.png](https://suitecrm.com/wiki/media/image181.png)

*Note: For full details on adding and managing dashlets, see the
[Dashlets](#Dashlets) section of this user guide.*
...
![image182.png](https://suitecrm.com/wiki/media/image182.png)

Select a chart or multiple charts and click 'Save'. This will display
the results in the chart selected.

![image183.png](https://suitecrm.com/wiki/media/image183.png)
...
![image184.png](https://suitecrm.com/wiki/media/image184.png)
...
![image185.png](https://suitecrm.com/wiki/media/image185.png)
...
![image186.png](https://suitecrm.com/wiki/media/image186.png)

Once you have entered a name and selected a schedule, click 'Save'.

![image187.png](https://suitecrm.com/wiki/media/image187.png)
...
![image188.png](https://suitecrm.com/wiki/media/image188.png)
...
![image189.png](https://suitecrm.com/wiki/media/image189.png)
...
![image190.png](https://suitecrm.com/wiki/media/image190.png)
...
![image191.png](https://suitecrm.com/wiki/media/image191.png)
...
![image192.png](https://suitecrm.com/wiki/media/image192.png)
...
![image193.png](https://suitecrm.com/wiki/media/image193.png)
...
![Image193a.png](https://suitecrm.com/wiki/images/d/de/Image193a.png)
...
1.  Navigate to Configure Tabs. Add Security Groups to the displayed
    tabs.
2.  Run Repair Roles, within Admin-&gt;Repair, to be able to assign
    rights to Security Groups.
...
3.  Add the groups to records in your SuiteCRM instance. You can use the
    Mass Assign on the List View to do this. Going forward the groups
    will automatically inherit based on your SecuritySuite Settings. You
    can also use logic hooks, workflow, or do a direct database insert
    into the securitygroups\_records table if doing a one-time initial
    setup.
...
-   [Example of a Typical
    Setup](https://www.sugaroutfitters.com/docs/securitysuite/example-of-a-typical-setup)
-   [Introduction
    Video](https://www.sugaroutfitters.com/docs/securitysuite/introduction-video)
...
1.  Create a role called Everything and set the rights to All.*Tips and
    Tricks: Click the header in any column on the role grid and you can
    set the rights for the whole column at one time*
...
*Note: Going forward the groups will be automatically inherited by any
...
direct database insertion into the securitygroups\_records table. See
...
![image194.png](https://suitecrm.com/wiki/media/image194.png)
...
*Note: The new record will still inherit from the Assigned To user or
...
third party module, provided by [JJW
Design](http://www.jjwdesign.com/).

Documentation and releases are kept up to date on the [JJW Maps project
page](http://www.jjwdesign.com/google-maps-for-sugarcrm/).
...
[forum](https://suitecrm.com/forum/suite-forum) the
knowledge is shared with everyone in the community. Our developers
answer questions on the forum daily but it also gives the other members
of the community the opportunity to contribute. If you would like
SalesAgility to customise SuiteCRM specifically for your needs, or to
provide a hosted and supported CRM solution, then please use our
[contact form](https://salesagility.com/contact-us).
...
maximising your use of SuiteCRM. You can also visit the [SuiteCRM
Community Forums](https://suitecrm.com/forum/suite-forum) where there are various topics and a wealth of knowledge provided
by the SuiteCRM team and contributing community members.

## Appendix A

## Contacts Field List

![Contacts.png](https://suitecrm.com/wiki/images/7/7d/Contacts.png)

## Leads Field List


![Leads.png](https://suitecrm.com/wiki/images/6/6f/Leads.png)

## Targets Field List


![Targets.png](https://suitecrm.com/wiki/images/b/b3/Targets.png)

## Accounts Field List


![Accounts.png](https://suitecrm.com/wiki/images/3/3f/Accounts.png)

## Opportunities Field List


![Opportunities.png](https://suitecrm.com/wiki/images/a/ac/Opportunities.png)

## Products Field List


![Products.png](https://suitecrm.com/wiki/images/9/97/Products.png)

## Product Categories Field List


![Product
Categories.png](https://suitecrm.com/wiki/images/f/f6/Product_Categories.png)

## Quotes Field List


![Quotes.png](https://suitecrm.com/wiki/images/6/65/Quotes.png)

## Invoices Field List


![Invoices.png](https://suitecrm.com/wiki/images/e/e1/Invoices.png)

## Contracts Field List


![Contracts.png](https://suitecrm.com/wiki/images/6/6a/Contracts.png)

## Line Items Field List


![Line Items.png](https://suitecrm.com/wiki/images/e/e9/Line_Items.png)

## Groups Field List


![Groups.png](https://suitecrm.com/wiki/images/4/43/Groups.png)

## PDF Templates Field List


![PDF Templates.png](https://suitecrm.com/wiki/images/4/43/PDF_Templates.png)

## Cases Field List


![Cases.png](https://suitecrm.com/wiki/images/8/8b/Cases.png)

## Notes Field List


![Notes.png](https://suitecrm.com/wiki/images/5/51/Notes.png)

## Calls Field List


![Calls.png](https://suitecrm.com/wiki/images/4/43/Calls.png)

## Emails Field List


![Emails.png](https://suitecrm.com/wiki/images/b/b5/Emails.png)

## Meetings Field List


![Meetings.png](https://suitecrm.com/wiki/images/c/c3/Meetings.png)

## Tasks Field List


![Tasks.png](https://suitecrm.com/wiki/images/e/e4/Tasks.png)

## Projects Field List


![Projects.png](https://suitecrm.com/wiki/images/a/ac/Projects.png)

## Project Tasks Field List


![Project Tasks.png](https://suitecrm.com/wiki/images/2/23/Project_Tasks.png)

## Campaigns Field List


![Campaigns.png](https://suitecrm.com/wiki/images/8/87/Campaigns.png)

## Target Lists Field List


![Target Lists.png](https://suitecrm.com/wiki/images/d/df/Target_Lists.png)

## Email Templates Field List


![Email
Templates.png](https://suitecrm.com/wiki/images/c/c1/Email_Templates.png)

## Documents Field List


![Documents.png](https://suitecrm.com/wiki/images/6/6a/Documents.png)

## Events Field List


![Events.png](https://suitecrm.com/wiki/images/e/e8/Events.png)

## Locations Field List


![Locations.png](https://suitecrm.com/wiki/images/c/c8/Locations.png)

## Users Field List


![Users.png](https://suitecrm.com/wiki/images/a/ab/Users.png)
