...
job queue (see the link:chap11.xhtml#logic-hooks-chapter[Logic Hook] and
link:chap12.xhtml#scheduled-tasks-chapter[Scheduled Tasks] chapters).
...
link:chap02.xhtml#working-with-beans-chapter[Working with beans]). There
