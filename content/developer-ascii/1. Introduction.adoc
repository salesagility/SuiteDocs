...
---
[[leanpub-auto-introduction]]
1. Introduction
~~~~~~~~~~~~~~~

[[leanpub-auto-what-is-suitecrm]]
What is SuiteCRM
^^^^^^^^^^^^^^^^
...
[[leanpub-auto-reading-this-book]]
Reading this book
^^^^^^^^^^^^^^^^^
...
[[leanpub-auto-setting-up-suitecrm]]
Setting up SuiteCRM
^^^^^^^^^^^^^^^^^^^
