...
|Language |N/A^link:chap13.xhtml#fn-langNote[1]^ |  |Used to add, update
or delete language strings for both modules and app strings. See the
chapter on link:chap08.xhtml#language-chapter[Language Strings].
...
a module. See the section on link:chap03.xhtml#vardefs-chapter[Vardefs].
